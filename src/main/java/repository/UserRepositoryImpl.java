package repository;
import co.edu.sena.demo.modelo.user;


import java.sql.*;
import java.util.ArrayList;
import java.util.List;
    public class UserRepositoryImpl<User> extends repository<User> {
        ...
        @Override
            ...
            public Integer saveObj(User user) throws SQLException {
                ...
                try (Connection conn = DBConnection.getConnection();
                    ...
                    if(user.getClass() != null && user.getClass() > 0){
                        ps.setInt(5, user.getClass().getModifiers());
                    }
